...
const DICT = {
  ...
  exportBtn:      { ar:'تصدير', en:'Export' },
  exportPdf:      { ar:'PDF', en:'PDF' },
  exportImage:    { ar:'صورة', en:'Image' },
  exportExcel:    { ar:'Excel', en:'Excel' },
  exporting:      { ar:'جارِ التصدير...', en:'Exporting...' },
  ...
  actionConfirmBooking: { ar:'تأكيد الحجز', en:'Confirm booking' },
  ...
  centerLogoLabel: { ar:'شعار المركز', en:'Center logo' },
  removeLogoBtn:  { ar:'إزالة الشعار', en:'Remove logo' },
  logoHint:       { ar:'يُفضّل صورة مربعة، وسيتم تصغيرها تلقائيًا', en:'A square image works best — it will be resized automatically' },
  ...
  sessionMinutesLabel: { ar:'مدة الجلسة قبل الخروج التلقائي (دقيقة)', en:'Session duration before auto-logout (minutes)' },
  sessionMinutesHint: { ar:'لو المستخدم فضل من غير حركة على الشاشة للمدة دي، هيتسجّل خروجه تلقائيًا.', en:'If the user stays inactive for this long, they will be signed out automatically.' },
  sessionMinutesShort: { ar:'مدة الجلسة', en:'Session' },
  sessionExpiredTitle: { ar:'انتهت الجلسة', en:'Session expired' },
  sessionExpiredText: { ar:'تم تسجيل خروجك تلقائيًا بسبب عدم النشاط. سجّل الدخول تاني للمتابعة.', en:'You were signed out automatically due to inactivity. Please sign in again.' },
  sessionRemaining: { ar:'الوقت المتبقي للجلسة', en:'Session time remaining' },
  ...
  statusConfirmed: { ar:'تم التأكيد', en:'Confirmed' },
